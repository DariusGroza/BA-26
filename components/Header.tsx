...
const Header: React.FC<HeaderProps> = ({ gameState, onNextWeek, onViewChange }) => {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              ...
              <span className="text-[9px] font-black text-gray-500 uppercase tracking-widest">CASH: <span className="text-green-500">{formatCurrency(gameState.cash)}</span></span>
              ...
              <div className={`px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-tighter ${isTransferSeason ? 'bg-red-500/20 text-red-500 animate-pulse' : 'bg-green-500/20 text-green-500'}`}>
                {isTransferSeason ? 'Transfer Window' : 'Regular Season'}
              </div>
            </div>
          </div>
        </div>
